...
async function loadGame() {
    try {
        ...
        if (wordData) {
            ...
            if (errorMessage) {
                errorMessage.innerHTML = "<span class='text-l'><strong>Uh oh! No word for today.</strong></span><br />Email <a href='mailto:jon@livingdead.co'>jon@livingdead.co</a> &amp; let him know.";
